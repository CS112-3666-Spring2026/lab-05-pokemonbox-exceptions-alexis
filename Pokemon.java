...
public Pokemon(
	...
	if (!this.setAll(name, type1, type2)) {
		...
		throw new IllegalArgumentException(
			"Pokemon full constructor illegal argument passed"
		);
	}
}
...
public Pokemon(Pokemon p)
	...
	if (p == null) {
		...
		throw new IllegalArgumentException(
			"Pokemon copy constructor illegal argument (null) passed."
		);
	}
...
private String toTitleCaseWord(
		String word
) {
